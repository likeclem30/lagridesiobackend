...
helpers.zenoTripDBLocal =
  "mongodb://lagride:lagride@172.30.218.218:27017/lagride";
...
helpers.getInputValueArray = (inputObj, field) => {
  return inputObj instanceof Object &&
    inputObj.hasOwnProperty(field) &&
    inputObj[field] instanceof Array
    ? inputObj[field]
    : "";
};
...
helpers.getWaitingTimeCharges = (
  waitingTime,
  maxAllowTimeInSec = 180,
  chargePerMinute = 50
) => {
  let getTimeSpent = waitingTime
    ? waitingTime > maxAllowTimeInSec
      ? waitingTime - maxAllowTimeInSec
      : 0
    : 0;
